...
const Login = () => {
    ...
    const func_iniciarSession = async () => {
        ...
        let respuestaAPI = await fetch("http://localhost:3000/login/iniciarSesion/", {
            method: "POST",
            headers: {
                    ...
                    <div className="row gx-lg-5 align-items-center mb-5">
                        <div className="col-lg-6 mb-5 mb-lg-0" style={{ zIndex: "10" }}>
                            <h1 className="my-5 display-5 fw-bold ls-tight" style={{ color: " hsl(218, 81%, 95%)" }}>
                                Restaurante <br />
                                <span style={{ color: "hsl(218, 81%, 75%)" }}>Casa Vieja</span>
                            </h1>
                                ...
                                <div className="card-body px-4 py-5 px-md-5">
                                    <form>
                                        ...
                                        <div className="btnIniciar">
                                            <button onClick={func_iniciarSession} type="button" className="btn btn-primary btn-block mb-4">
                                                Iniciar
                                            </button>
                                        </div>
